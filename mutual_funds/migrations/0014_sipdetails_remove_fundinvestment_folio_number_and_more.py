    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_unrealised_purchase_date', models.DateField(blank=True, null=True)),
                ('current_value', models.FloatField()),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fund_investment_folios', to=settings.AUTH_USER_MODEL)),
                ('sip_details', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='mutual_funds.sipdetails')),
            ],
        ),
        migrations.AddField(
            model_name='fundinvestment',
            name='folios',
            field=models.ManyToManyField(blank=True, related_name='fund_investments', to='mutual_funds.fundinvestmentfolio'),
        ),
    ]
