...
@admin.register(TodaysMacroSectorPerformance)
class TodaysMacroSectorPerformanceAdmin(admin.ModelAdmin):
    list_display = ["id", "datetime", "data"]
